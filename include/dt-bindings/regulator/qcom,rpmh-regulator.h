...
#define RPMH_REGULATOR_LEVEL_LOW_SVS_D1	(55 + RPMH_REGULATOR_LEVEL_OFFSET)
#define RPMH_REGULATOR_LEVEL_LOW_SVS	(63 + RPMH_REGULATOR_LEVEL_OFFSET)
#define RPMH_REGULATOR_LEVEL_LOW_SVS_L1	(79 + RPMH_REGULATOR_LEVEL_OFFSET)
#define RPMH_REGULATOR_LEVEL_LOW_SVS_L2	(95 + RPMH_REGULATOR_LEVEL_OFFSET)
